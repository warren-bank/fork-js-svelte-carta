import { BROWSER as a } from "esm-env";
const s = (t) => ({
  ...
  listeners: [
    [
      "carta-render",
      async (e) => {
        a && (await import("./browser-CEksbyWR.js")).processTikzScripts(e, t);
      }
    ]
  ],
  grammarRules: [
  ...
  return a ? (await import("./browser-CEksbyWR.js")).browserTikzTransform(n, t, e) : await (await import("./node-TGvEb-3T.js")).nodeTikzTransform(n, t, e);
};
export {
  s as tikz
};
