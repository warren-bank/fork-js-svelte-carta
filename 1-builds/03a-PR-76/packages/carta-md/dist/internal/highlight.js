 ...
 */
export const isBundleLanguage = (lang) => Object.keys(bundledLanguages).includes(lang);
/**
 * Checks if a theme is a bundled theme.
 * @param theme The theme to check.
 * @returns Whether the theme is a bundled theme.
 */
export const isBundleTheme = (theme) => Object.keys(bundledThemes).includes(theme);
/**
 ...
 */
export const loadLanguage = async (highlighter, lang, loadedLanguages) => {
    if (!loadedLanguages)
