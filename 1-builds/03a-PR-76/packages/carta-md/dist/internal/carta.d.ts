...
import { type Highlighter, type GrammarRule, type ShikiOptions, type DualTheme, type Theme, type HighlightingRule } from './highlight';
/**
...
export declare class Carta {
    ...
    readonly asyncProcessor: Promise<Processor>;
    private mElement;
    private mInput;
    private mRenderer;
    ...
    loadHighlighterLanguage(highlighter: Highlighter, lang: string): Promise<boolean>;
