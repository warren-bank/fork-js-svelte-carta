...
const genericConfigOptions = {
  input: 'src/plugin-attachment.js',
  plugins: [
    commonjs(),
    svelte({
...
config.push({
  ...
  output: [
    {
      format: 'es',
      file: 'dist/plugin-attachment.mjs',
  ...
  output: [
    {
      format: 'cjs',
      name: 'CartaMd',
      file: 'dist/plugin-attachment.cjs',
      inlineDynamicImports: true,
      strict: false,
      exports: 'default'
    },
    {
      format: 'umd',
      name: 'CartaMd',
      file: 'dist/plugin-attachment.umd.js',
      inlineDynamicImports: true,
      strict: false,
      globals: {
        shiki: 'shiki'
...
config.push({
  ...
  output: [
    {
      format: 'es',
      file: 'dist/plugin-attachment.min.mjs',
      inlineDynamicImports: true
    }
  ]
})
  ...
  output: [
    {
      format: 'iife',
      name: 'CartaMd',
      file: 'dist/plugin-attachment.min.js',
      inlineDynamicImports: true,
      strict: false,
      globals: {
        shiki: 'shiki'
