...
/* ..\..\1-builds\07-upstream-master\packages\plugin-emoji\dist\Emoji.svelte generated by Svelte v4.2.18 */
...
function create_each_block(ctx) {
	...
	return {
		c() {
			...
			attr(button, "title", button_title_value = /*emoji*/ ctx[15].name);
		},
		m(target, anchor) {
		...
		p(new_ctx, dirty) {
			...
			if (dirty & /*emojis*/ 128 && button_title_value !== (button_title_value = /*emoji*/ ctx[15].name)) {
...
function instance($$self, $$props, $$invalidate) {
	...
	function handleKeyUp(e) {
		...
		if (carta.input.textarea.selectionStart < colonPosition) {
			...
			$$invalidate(7, emojis = search(filter).slice(0, cols * maxRows));
