...
function element(node, options) {
  ...
  const fn = space === webNamespaces.svg ? s : h$1;
  const tagName =
...
var h = /*@__PURE__*/getDefaultExportFromCjs(md5Exports);
...
const j = (r$1, i, e) => {
  ...
  visit(r$1, (t, m, c) => {
    ...
    const u = r(s.children[0].value), a = document.createElement("div"), d = document.createElement("div"), o = document.createTextNode(u);
    ...
    const f = fromDom(a);
    return c == null || c.children.splice(m, 1, f), [SKIP, m];
  });
};
function L(r, i) {
  var t;
...
export { j as browserTikzTransform, L as processTikzScripts };
